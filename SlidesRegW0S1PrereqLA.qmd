...
- In $\symbf{AB}$, the $ij$-th element is the dot product of $i$-th row of $\symbf{A}$ and the the $j$-th column of $\symbf{B}$, i.e. $(\symbf{AB})_{ij} = \symbf{a}_{[i]}'\cdot\symbf{b}_{j}$.
...
\symbf{AB}=
\begin{bmatrix}
\symbf{a}_{[1]}'\cdot\symbf{b}_{1} & \symbf{a}_{[1]}'\cdot\symbf{b}_{2} & \symbf{a}_{[1]}'\cdot\symbf{b}_{3} \\
\symbf{a}_{[2]}'\cdot\symbf{b}_{1} & \symbf{a}_{[2]}'\cdot\symbf{b}_{2} & \symbf{a}_{[2]}'\cdot\symbf{b}_{3} \\
\symbf{a}_{[3]}'\cdot\symbf{b}_{1} & \symbf{a}_{[3]}'\cdot\symbf{b}_{2} & \symbf{a}_{[3]}'\cdot\symbf{b}_{3}
\end{bmatrix}
$$
