...
- The document `DemRegW1L3LinearAlgebra.html` (in `0. Prerequisites` on Amathuba) covers some of the key concepts above and shows you to perform the linear algebra in \texttt{R}.
